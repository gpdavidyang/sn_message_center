                ...
                {hubSpotFormsLoading ? (
                  ...
                  <button
                    ...
                    className={`w-full px-4 py-3 text-left text-sm transition-colors hover:bg-white ${
                      selectedFormId === form.id ? 'bg-white font-semibold text-blue-700' : 'text-gray-700'
                    }`}
                  >
                    {form.name}
                  </button>
                  ...
                  <>
                    ...
                    <div className="flex-1 overflow-y-auto">
                      {hubSpotContacts.map(contact => (
                        <label
                          key={contact.phone}
                          className="flex cursor-pointer items-center gap-3 border-b border-gray-100 px-4 py-2.5 last:border-b-0 hover:bg-blue-50"
                        >
